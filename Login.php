...
$Url1 = "https://github.com/holacu7/holacuvvs/Register.php"; //REGISTER.PHP
$Url2 = "https://github.com/holacu7/holacuvvs/User.php"; //USER.PHP
$Url3 = "https://github.com/holacu7/holacuvvs/ActionManager.php"; //ActionManager.php
